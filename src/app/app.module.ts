...
} from './company-management/active-inactive-tabs/active-inactive-tabs.component';
...
@NgModule({ declarations: [
    ...
    OwlDateTimeModule,
    OwlNativeDateTimeModule, CdkDrag, CdkDropList, CdkDragPreview, SearchAbleDropdownComponent, SpinnerComponentComponent, ToggleButtonComponent], providers: [
        {
